...
export interface AnimatedCounterRetroTechMagazineTemplateProps {
  value: number;
  label: string;
  icon: ReactNode;
...
export function AnimatedCounterRetroTechMagazineTemplate({
  value,
  label,
  icon,
  color = 'text-[#39FF14]',
  id,
}: AnimatedCounterRetroTechMagazineTemplateProps) {
