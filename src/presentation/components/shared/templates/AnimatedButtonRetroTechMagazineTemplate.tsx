...
export interface AnimatedButtonRetroTechMagazineTemplateProps {
  children: ReactNode;
  onClick?: () => void;
...
export function AnimatedButtonRetroTechMagazineTemplate({
  children,
  onClick,
  variant = 'primary',
  size = 'md',
  ...
  icon,
  id,
}: AnimatedButtonRetroTechMagazineTemplateProps) {
