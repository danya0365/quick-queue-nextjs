...
export interface QueueNumberBadgeRetroTechMagazineTemplateProps {
  number: number;
  size?: 'sm' | 'md' | 'lg';
...
export function QueueNumberBadgeRetroTechMagazineTemplate({
  number,
  size = 'md',
  variant = 'default',
  id,
}: QueueNumberBadgeRetroTechMagazineTemplateProps) {
