...
export interface HomeClassicLayoutProps {
...
export function HomeClassicLayout({
  ...
  return (
    <div className="h-full flex flex-col p-3 sm:p-6 gap-3 sm:gap-5 overflow-y-auto" id="home-classic-layout">
      {/* ─── Hero Section ─── */}
