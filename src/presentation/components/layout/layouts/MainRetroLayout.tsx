...
export interface MainRetroLayoutProps {
  children: React.ReactNode;
}

export function MainRetroLayout({ children }: MainRetroLayoutProps) {
  return (
    <div
      className="
        flex flex-col
    ...
    >
      ...
      {/* ─── Retro Footer ─── */}
      <footer className="border-t-8 border-black bg-black text-white px-6 py-3 font-bold uppercase text-xs sm:text-sm text-center shrink-0 z-50">
